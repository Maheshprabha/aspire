...
public class TC10_PopupPage extends TestSuiteBase{
    ...
    report.info("Clicking on the search button ");
    helper.clickonelement("loc.timesheet.search.btn");
    report.info("Successfully clicked search button");
